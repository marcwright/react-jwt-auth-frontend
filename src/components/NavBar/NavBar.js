...
class NavBar extends Component {
  ...
  render() {
    ...
    if (this.props.isLoggedIn) {
      ...
      navBarItems.push(<NavItem key={6} href='/letsPlay'>Let's Play</NavItem>)
    }
    return (
      <Navbar brand='Lets Play Jeopardy' className='nav' right>
  ...
  newMethod(navBarItems) {
    if (this.props.isLoggedIn) {
      navBarItems.push(<NavItem key={6} href='/letsPlay'>Choose</NavItem>);
    }
  }
}
